      ...
      <Container maxWidth="lg" sx={{ textAlign: "center"}}>
            ...
            <Container maxWidth="lg" sx={{ textAlign: "center"}}>
                ...
                {data && data.length > 0 ? data.map((obj)=>{
                 return<div> <Grid sx={{ marginY: "30px", padding: "30px", backgroundColor: "white", boxShadow: "5px 5px 30px lightgray", borderRadius: "10px" }}  item xs={12} md={12} sm={12} lg={12} ><Typography component="div"  variant="h6">Question : {obj.question}</Typography>
                   <Typography component="div" variant="p">Correct Option : {obj.correctOption}</Typography>
                 {obj.options.map((option)=>{
                  return <div><Typography component="div"  variant="p">Option : {option}</Typography></div>
                 })}
                </Grid></div>
                }):""}
                  </Grid>
